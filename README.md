## MAX to TG bot
Бот, который позволяет ретранслировать входящие сообщения из MAX в Telegram
...
max_api_token=<TOKEN> # Можно получить, зайдя в веб версию MAX. Откройте режим разработчика и найдите токен в localStorage
